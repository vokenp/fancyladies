...
class PendingSMSBoxController extends Controller
{
    /**
    ...
    {
        $this->menuLinkName = "smspendingbox";

        $this->middleware('auth');
        $this->page_title = 'Pending SMS Box';
        $this->page_description = 'This is Page is Used to View Pending SMS Box';
    ...
    public function index()
    {
        $data = [
            ...
            'content'    => 'pages.Apps.SMS.smsPendingBox_view',
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $q_user = BongaSmsout::select('*')->where('send_status','=', 'pending')->orderByDesc('created_at');
