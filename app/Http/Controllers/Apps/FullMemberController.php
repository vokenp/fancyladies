...
class FullMemberController extends Controller
{
    /**
    ...
    {
        $this->menuLinkName = "fullmember";
        $this->modalName = "fullmember_create_modal";
        $this->middleware('auth');
        $this->page_title = 'Church Members';
    ...
    public function index(Request $request)
    {
        ...
        $columns[] = array('data' => 'member_no', 'name' => 'member_no', 'title' =>'Member No');
    ...
    {
        if ($request->ajax()) {
            $q_Members = Members::select('*')->where('member_type','=', 'FullMember')->orderByDesc('created_at');
