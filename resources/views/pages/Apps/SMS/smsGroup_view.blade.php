            ...
            <div class="card card-custom gutter-b">
                <div class="card-header  bg-gray-700">
                    <div class="card-title">
                        <h3 class="card-label text-white" id="tblCaption">SMS Group List</h3>
                    ...
                    <div class="card-toolbar">
                        <a href="#" id="AddNewRec" class="btn btn-warning btn-sm font-weight-bolder mr-1" title="Add New Template"> <span class="svg-icon svg-icon-md">
                            <i class="flaticon2-plus text-white"></i></span>Add New Group</a>
                    </div>
...
<script>
    $(function () {
        ...
        $('#AddNewRec').click(function(){
            $('#row_id').val("");
            $('#smsGroup_edit').modal('show');
            $('#modalLabel').html("Add New SMS Group");
            $('#btnSubmit').html('Save Group');
           });
          ...
          $('body').on('click', '.editRecord', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalLabel').html("Update SMS Group");
                    $('#btnSubmit').html('Update Group');
...
@include('pages.Apps.SMS.smsGroup_edit');
