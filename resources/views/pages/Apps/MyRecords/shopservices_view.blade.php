            ...
            <div class="card card-custom gutter-b">
                <div class="card-header  bg-gray-700">
                    <div class="card-title">
                        <h3 class="card-label text-white" id="tblCaption">Shop Services List</h3>
                    ...
                    <div class="card-toolbar">
                        <a href="#" id="AddNewRec" class="btn btn-warning btn-sm font-weight-bolder mr-1" title="Add New Template"> <span class="svg-icon svg-icon-md">
                            <i class="flaticon2-plus text-white"></i></span>Add New Service</a>
                    </div>
...
<script>
    $(function () {
        ...
        $('#AddNewRec').click(function(){
            $('#row_id').val("");
            $('#shopservices_edit').modal('show');
            $('#modalLabel').html("Add New Service");
            $('#btnSubmit').html('Save Service');
           });
          ...
          $('body').on('click', '.editRecord', function () {
            ...
            $.ajax({
                type: "GET",
                url:  "/apps/shopservices/"+row_id+"/edit/",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                success: function (data) {
                    ...
                    $('#service_commission').val(data["service_commission"]);
                    $('#modalLabel').html("Update Shop Service");
                    $('#btnSubmit').html('Update Service');
...
@include('pages.Apps.MyRecords.shopservices_edit');
