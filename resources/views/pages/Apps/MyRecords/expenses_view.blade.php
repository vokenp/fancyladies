            ...
            <div class="card card-custom gutter-b">
                <div class="card-header  bg-gray-700">
                    <div class="card-title">
                        <h3 class="card-label text-white" id="tblCaption">Shop Expenses List</h3>
                    ...
                    <div class="card-toolbar">
                        <a href="#" id="AddNewRec" class="btn btn-warning btn-sm font-weight-bolder mr-1" title="Add New Template"> <span class="svg-icon svg-icon-md">
                            <i class="flaticon2-plus text-white"></i></span>Add New expenses</a>
                    </div>
...
<script>
    $(function () {
        ...
        $('#AddNewRec').click(function(){
            $('#row_id').val("");
            $('#expenses_edit').modal('show');
            $('#modalLabel').html("Add New expenses");
            
            $('#btnSubmit').html('Save expenses');
            $('#formData2').trigger("reset");
           });
          ...
          $('body').on('click', '.editRecord', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#expense_mop').val(data["expense_mop"]);
                    $('#expense_amount').val(data["expense_amount"]);
                    $('#expense_remarks').val(data["expense_remarks"]);
                    $('#modalLabel').html("Update Expenses");
                    $('#btnSubmit').html('Update Expenses');
...
@include('pages.Apps.MyRecords.expenses_edit');
