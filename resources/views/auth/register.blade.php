  ...
  <form class="text-center form" id="kt_login_signup_form" method="POST" action="/register">
    ...
    <div class="form-group">
      <button id="kt_login_signup_submit" type="submit"
        class="py-3 m-2 btn btn-pill btn-outline-success font-weight-bold opacity-190 px-15">Sign
        Up</button>
      <a id="kt_login_signup_cancel"
        href="/" class="py-3 m-2 btn btn-pill btn-outline-warning font-weight-bold opacity-170 px-15">Cancel</a>
    </div>
  </form>
</div>
