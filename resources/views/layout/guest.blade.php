  ...
  <div class="d-flex flex-column flex-root" >
    ...
    <div class=" login login-3 {{ $pageclass }} d-flex flex-row-fluid " id="kt_login">
      <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
        style="background-image: url({{ asset('media/bg/fronbg.png') }});" >
        <div class=" card overflow-hidden text-center text-dark login-form p-7  position-relative opacity-150 ">
          <!--begin::Login Header-->
          <div class="d-flex flex-center mb-15 align-items-end">
            <a href="#">
